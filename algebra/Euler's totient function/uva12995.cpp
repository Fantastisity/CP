...
void init() {
	...
	separate the consecutive farey sequences in Fn-1, thereby creating ϕ(n) non-consecutive 
	sequences. Hence, the total number of farey sequences is Σi∈[2, n] ϕ(i)
    */
	F(i, 2, MAXN) phi[i] = i;
